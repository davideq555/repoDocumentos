                ...
                <div class="lg:grid lg:grid-cols-2 lg:gap-8">
                  <div class="mx-auto max-w-md px-4 text-center sm:max-w-2xl sm:px-6 lg:flex lg:items-center lg:px-0 lg:text-left">
                    <div class="lg:py-24">
                      ...
                      <p class="mt-3 text-base text-gray-400 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">Tesis, seminarios, investigaciones, revistas y más, todo de la facultad de Ciencias Exactas</p>
                      <div class="mt-10 sm:mt-12">
                        ...
                        <form class="sm:mx-auto sm:max-w-xl lg:mx-0" action="https://api.web3forms.com/submit">
                          <div class="sm:flex">
                            ...
                            <div class="min-w-0 flex-1"><label for="email" class="sr-only">Email address</label><input id="email" type="email" placeholder="Encuentra tu documento" class="block w-full rounded-md border-0 bg-gray-200 px-4 py-3 text-base text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-400" value="" autocomplete="off" /></div>
          ...
          <footer class="bg-white">
            <div class="mx-auto max-w-7xl overflow-hidden py-12 px-4 sm:px-6 lg:px-8">
              ...
              <div class="mt-8 flex justify-center space-x-6">
                <a href="https://twitter.com/web3templates" class="text-gray-400 hover:text-gray-500"
                ...
                </svg></a><a href="https://github.com/web3templates" class="text-gray-400 hover:text-gray-500">
              ...
              <p class="mt-8 text-center text-base text-gray-400">© 2022 Web3Templates. All rights reserved.</p>
            </div>
          </footer>
          @stack('modals')
