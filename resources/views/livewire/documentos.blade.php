           ...
           <div class="p-2 flex">
            <div class=" flex items-center justify-between pb-2">
                <div class="flex items-center justify-between">
                    <div class="lg:mr-80 mr-10 space-x-2">
                    ...
                    <div class="flex self-end bg-gray-50 items-center p-2 rounded-md">
                        ...
                        <tr class="border-b hover:bg-orange-100 bg-gray-100">
                            ...
                            <td class="p-3 px-5 flex justify-center">
                                ...
                                <button type="button"
                                    ...
                                    class="mr-1 text-sm bg-blue-700 hover:bg-blue-900 text-white py-1 px-2 focus:outline-none focus:shadow-outline">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                ...
                                <button type="button" 
                                    ...
                                    class="text-sm bg-red-700 hover:bg-red-900 text-white py-1 px-2 rounded rounded-r-2xl focus:outline-none focus:shadow-outline">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
