<div class="p-6 sm:px-20 bg-white border-b border-gray-200">
    ...
    <div class="mt-8 text-2xl">
        Bienvenido al panel de control de repoDocumentos
    </div>

    <div class="mt-6 text-gray-500">
        <p>La intencion de la aplicacion es para subir todos los documentos generados por la facultad, aunque tambien podria adaptarse a la universidad</p>
    </div>
    @role('Invitado')
    <div class="p-6 text-gray-500">
        <p>Espera hasta que el administrador te de el alta con el rol correcto</p>
    </div>
    @endrole
</div>
